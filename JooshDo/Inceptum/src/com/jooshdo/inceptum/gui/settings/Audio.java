...
public class Audio {
	...
	public void render( Graphics g ) {
		...
		//Title
		g.drawImage( Game.tex.getSettings().get( 8 ), Scale.posX( Reference.widthScreen / 2 - 200 + 130 ), Scale.posY( Reference.heightScreen / 4 - 50 ), Scale.width( 400 ), Scale.height( 100 ), null );
